        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmergencySchedules_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "Id", "Email", "Password", "SpecialityId", "UserName" },
                values: new object[,]
                {
                    { 1, "admin_general@gmail.com", "password123", 1, "admin_general" },
                    { 2, "admin_emergency@gmail.com", "password123", 2, "admin_emergency" },
                    { 3, "admin_pediatrics@gmail.com", "password123", 3, "admin_pediatrics" },
                    { 4, "admin_cardiology@gmail.com", "password123", 4, "admin_cardiology" },
                    { 5, "admin_orthopedics@gmail.com", "password123", 5, "admin_orthopedics" }
                });
